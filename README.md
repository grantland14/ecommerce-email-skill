...
3. Start a new Claude Code conversation — Claude will automatically use the skills when relevant

Or install individual skills by copying just the `SKILL.md` file from any skill folder.
